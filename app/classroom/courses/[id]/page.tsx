...
export default function CoursePage() {
		...
		const checkRegistration = async () => {
			try {
				const response = await fetch(
					`/api/courses/${courseId}/check-registration?userId=${userId}`
				)
	...
	const instructorAvatar =
		course.instructorAvatar || getAvatarPlaceholder(course.instructorName)
				...
				<div className="flex items-center mb-6">
					...
					<div>
						...
						<h3 className="text-white font-medium">
							{course.instructorName || "Tidak tersedia"}
						</h3>
					</div>
				...
				<div>
					...
					<div className="space-y-6">
						{course.modules.map((module) => {
							...
							let moduleLink = `/classroom/courses/java-101`
							if (course.id == 1 && module.id === 2) {
								moduleLink = "/classroom/courses/java/quiz"
							}

							return (
								<div
									key={module.id}
									className="bg-gray-800 rounded-lg p-4 transition hover:bg-gray-700">
									<div className="flex">
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div className="bg-gray-800 rounded-lg p-5 hover:bg-gray-700 transition">
							...
							<p className="text-gray-400 mb-4">
								Panduan penggunaan teknologi bantu untuk pemrograman bagi
								disabilitas tangan.
							</p>
							<a
								href="#"
						...
						<div className="bg-gray-800 rounded-lg p-5 hover:bg-gray-700 transition">
							...
							<p className="text-gray-400 mb-4">
								Video pembelajaran tambahan dengan penjelasan visual dan
								subtitle.
							</p>
							<a
								href="#"
			...
			<div className="mt-8 flex justify-between">
				...
				{!isRegistered ? (
					<button
						...
						className={`bg-green-600 hover:bg-green-500 text-white py-2 px-6 rounded-lg transition ${
					...
					<button
						onClick={() => {
							if (course.modules.length > 0) {
								...
								router.push(
									`/classroom/courses/${courseId}/module/${nextModule.id}`
								)
							}
						}}
						className="bg-blue-600 hover:bg-blue-500 text-white py-2 px-6 rounded-lg transition">
